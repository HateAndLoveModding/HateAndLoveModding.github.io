...
<div class="todo">TODO: how much of the rule enforcement (legal-move checking versus trusting the player) is actually built into the GUI is a specific implementation detail Ryker should confirm here rather than have this page assume.</div>
